...
bg = pygame.image.load('Assets\UI.png')
...
purple = pygame.image.load('Assets\Purple.png')
orange = pygame.image.load('Assets\Orange.png')
pink = pygame.image.load('Assets\Pink.png')
...
shape_images = [(red), (blue), (green), (orange), (yellow), (purple), (pink)]
...
def create_grid(locked_pos={}):
    grid = [[(0,0,0) for _ in range(10)] for _ in range(18)]
...
def valid_space(shape, grid):
    accepted_pos = [[(j, i) for j in range(10) if grid[i][j] == (0,0,0)] for i in range(18)]
...
def draw_next_shape(shape, surface):
    ...
    for i, line in enumerate(format):
        ...
        for j, column in enumerate(row):
            if column == '0':
                pygame.draw.rect(surface, shape.image, (sx + j*block_size, sy + i*block_size, block_size, block_size), 0)
...
def draw_window(surface, grid, score=0, last_score = 0):
    surface.blit('Assets\UI.png', (0, 0))
